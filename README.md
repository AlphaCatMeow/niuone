...
- **题材强度与策略研究**：默认复用 30 秒全市场行情采样更新日内题材强度；内置基础、Z 哥、李大霄、板块潮汐和牛牛战法，牛牛战法包含日线区间 V 型试仓、跨日主线确认以及启动/领涨/转强。
...
| `/niuone-mainline` | 全市场跨日主线、日内强度、日内 V 形修复观察和代表股 | 使用公开行情；消息确认模型可选 |
