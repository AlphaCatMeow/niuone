...
3. 牛牛领航：只做进攻/轮动行情的跨交易日已确认主线，个股必须为主线核心前20%，只买有效突破或首次EMA20缩量回踩；单日涨幅>4%或距EMA20>1ATR不追，30%是单票绝对上限。
4. 牛牛回踩：主线仍为mainline/diverging且分数≥70，个股在前30%，只做EMA20承接或重新收复；单日涨幅>4%或距EMA20>1ATR不追；25%是单票绝对上限。
5. 牛牛启动：主题必须处emerging并已跨交易日延续，至少两只核心强势股保持连续，核心股突破/收复才用观察仓；单日涨幅>7%或距EMA20>1.5ATR不追；15%是单票绝对上限，升级主线后才允许加仓。
